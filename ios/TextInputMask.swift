    ...
    func setMask(reactNode: NSNumber, mask: String, options: NSDictionary) {
        bridge.uiManager.addUIBlock { (uiManager, viewRegistry) in
            DispatchQueue.main.async {
                ...
                let maskedDelegate = MaskedTextFieldDelegate(primaryFormat: mask, autocomplete: autocomplete, autocompleteOnFocus: false, autoskip: autoskip, rightToLeft: rightToLeft, affineFormats: affineFormats, customNotations: customNotations) { (_, value, complete) in
